...
const SAMPLE_RESERVATIONS = [
  { no: "SG-260702-014", status: "pending", treatmentName: "프리미엄 종합검진 (PET-CT)", hospital: "세브란스 체크업", customer: { name: "James Carter", nationality: "United States", phone: "+1 415-555-0182", email: "j.carter@example.com" }, party: 1, dates: { arrival: "2026-07-21", departure: "2026-07-26", preferred: "2026-07-22" }, amount: 2480, coordinator: "미배정", createdAt: "2026-07-02T09:12:00", memo: "PET-CT 옵션 문의, 통역(영어) 필요" },
  { no: "SG-260701-009", status: "confirmed", treatmentName: "리쥬란 힐러 3회 패키지", hospital: "라클리닉 청담", customer: { name: "Yuki Tanaka", nationality: "Japan", phone: "+81 90-1234-5678", email: "yuki.t@example.jp" }, party: 2, dates: { arrival: "2026-07-15", departure: "2026-07-19", preferred: "2026-07-16" }, amount: 1740, coordinator: "김서연", createdAt: "2026-07-01T14:40:00", memo: "친구 동반(2인) — 인접 시술 희망" },
  { no: "SG-260701-004", status: "confirmed", treatmentName: "임플란트 상담 + 파노라마", hospital: "서울대치과", customer: { name: "Fatima Al-Rashid", nationality: "UAE", phone: "+971 50-123-4567", email: "fatima.r@example.ae" }, party: 1, dates: { arrival: "2026-07-11", departure: "2026-07-18", preferred: "2026-07-12" }, amount: 620, coordinator: "박지훈", createdAt: "2026-07-01T08:05:00", memo: "아랍어 통역 · 여성 코디네이터 요청" },
  { no: "SG-260630-021", status: "completed", treatmentName: "눈밑 지방재배치", hospital: "리엔장 성형외과", customer: { name: "Chen Wei", nationality: "China", phone: "+86 138-0013-8000", email: "chen.wei@example.cn" }, party: 1, dates: { arrival: "2026-06-24", departure: "2026-07-01", preferred: "2026-06-25" }, amount: 3300, coordinator: "김서연", createdAt: "2026-06-30T11:20:00", memo: "시술 완료 · 사후관리 1회 예약됨" },
  { no: "SG-260629-018", status: "pending", treatmentName: "종합 건강검진 (기본)", hospital: "세브란스 체크업", customer: { name: "Somchai P.", nationality: "Thailand", phone: "+66 81-234-5678", email: "somchai@example.th" }, party: 3, dates: { arrival: "2026-08-02", departure: "2026-08-07", preferred: "2026-08-03" }, amount: 1950, coordinator: "미배정", createdAt: "2026-06-29T17:55:00", memo: "가족 3인 · 호텔 예약 지원 요청" },
  { no: "SG-260628-011", status: "cancelled", treatmentName: "물광주사 2회", hospital: "라클리닉 청담", customer: { name: "Olga Ivanova", nationality: "Russia", phone: "+7 903-123-4567", email: "olga.i@example.ru" }, party: 1, dates: { arrival: "2026-07-09", departure: "2026-07-12", preferred: "2026-07-10" }, amount: 480, coordinator: "박지훈", createdAt: "2026-06-28T10:02:00", memo: "일정 변경으로 고객 취소 — 재문의 예정" },
  { no: "SG-260627-006", status: "confirmed", treatmentName: "위·대장 내시경 (수면)", hospital: "서울대병원 건진센터", customer: { name: "Michael Brown", nationality: "United States", phone: "+1 212-555-0143", email: "m.brown@example.com" }, party: 2, dates: { arrival: "2026-07-13", departure: "2026-07-17", preferred: "2026-07-14" }, amount: 1120, coordinator: "김서연", createdAt: "2026-06-27T13:30:00", memo: "부부 동반 검진" },
];
...
const SAMPLE_LEADS = [
  ...
  { id: "L-2607-230", name: "David Kim", email: "d.kim@example.com", phone: "+1 213-555-0199", category: "건강검진", message: "Looking for a premium executive checkup for two, mid-July. What's included and total cost?", source: "search", market: "United States", status: "contacted", owner: "김서연", createdAt: "2026-07-03T02:15:00" },
  { id: "L-2607-228", name: "Mei Lin", email: "mei.lin@example.cn", phone: "+86 139-0013-9000", category: "피부과", message: "리쥬란이랑 물광 같이 받을 수 있나요? 3박 4일 일정입니다.", source: "referral", market: "China", status: "qualified", owner: "박지훈", createdAt: "2026-07-02T15:22:00" },
  { id: "L-2607-225", name: "Hiroshi Sato", email: "h.sato@example.jp", phone: "+81 80-9876-5432", category: "치과", message: "임플란트 4개 견적과 체류 기간 문의합니다.", source: "paid", market: "Japan", status: "converted", owner: "김서연", createdAt: "2026-07-02T09:48:00" },
  ...
  { id: "L-2607-218", name: "Somsak T.", email: "somsak.t@example.th", phone: "+66 82-345-6789", category: "종합병원", message: "Full body checkup for a family of 3. Hotel assistance available?", source: "instagram", market: "Thailand", status: "contacted", owner: "박지훈", createdAt: "2026-07-01T18:33:00" },
  { id: "L-2607-214", name: "Robert Wilson", email: "r.wilson@example.com", phone: "+1 305-555-0177", category: "정형외과", message: "Knee cartilage consultation + MRI. Second opinion from Seoul.", source: "referral", market: "United States", status: "qualified", owner: "김서연", createdAt: "2026-07-01T11:05:00" },
  { id: "L-2607-209", name: "Layla Hassan", email: "layla.h@example.ae", phone: "+971 52-111-2233", category: "피부과", message: "Acne scar program. How many sessions and total days in Seoul?", source: "instagram", market: "UAE", status: "archived", owner: "박지훈", createdAt: "2026-06-30T20:40:00" },
];
